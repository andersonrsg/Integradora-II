...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        private float handbrakeAux;
        private float accelerationAux;
        private float distance;
        private float currentBattery;
        private float startTime;
        private float elapsedTime;

        public float batteryPerMeter;
        public float batteryPerMinute;
        ...
        void Update () {
            ...
            accelerationText.text = (accelerationAux * 100).ToString();

            if (currentSpeed * accelerationAux >= 0) {
                movementDirectionText.text = "Frente";
            } else {
                movementDirectionText.text = "Ré";
            }
            ...
            if (batteryPerMeter == 0f) {
                batteryPerMeter = 0.000000000001f;
            } 
        ...
        {
            accelerationAux = accel;
            handbrakeAux = handbrake;
